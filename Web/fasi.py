class Stage():
    ...
    def check(self, v):
        if str(self.value) != str(v):       #ATTENZIONE
            ...
            """
            Dati che potrebbero servire per la funzione:
            - cache_table.dati -> direttamente cache_table perchè dobbiamo vedere anche info cache
            - indici della matrice (livello e colonna) (riga in base alla fase)
            """
